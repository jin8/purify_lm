OUTPUT_DIR=/v3/minseon/Data/dexperts/generations/cont_gpt_bert_alpha/generation/alpha_05/
PROMPTS_DATASET=/v3/minseon/iclr/data/realtoxicityprompts/prompts.jsonl
MODEL_DIR=/v3/minseon/Data/dexperts/models/contrastive/small/cont_gpt_bert_alpha_05/
NUM_GPU=4
