...
class DataTrainingArguments:
    ...
    train_data_files: Optional[List[str]] = field(
...
def get_dataset(args: DataTrainingArguments, tokenizer: PreTrainedTokenizer, evaluate=False):
    ...
    return TextAttrDataset(
            tokenizer=tokenizer, file_paths=file_paths, block_size=args.block_size, overwrite_cache=args.overwrite_cache, text_label=text_label,
    )
...
def main():
    ...
    data_collator = DataCollatorForLanguageModelingWithAttribute(
        tokenizer=tokenizer, mlm=data_args.mlm, mlm_probability=data_args.mlm_probability, text_att_flag=text_label
    )
    model.resize_token_embeddings(len(tokenizer))
